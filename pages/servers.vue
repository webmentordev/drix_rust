    ...
    <section class="w-full bg-center bg-cover min-h-screen relative" style="background-image: url('/background.webp');">
        ...
        <div class="relative z-10 max-w-6xl m-auto pt-[140px] px-4">
            ...
            <div v-else class="flex flex-col p-3 max-w-lg m-auto rounded-lg mt-6 bg-dark relative">
                ...
                <img :src="server.details.rust_headerimage" class="rounded-lg" alt="Drix'sEnergeyField Rust Header Image">
                <div class="p-3">
                ...
                <NuxtLink to="steam://connect/192.211.60.106:50930" class="link bg-main w-full text-center py-3 text-lg rounded-lg hover:text-white hover:bg-black transition-all" target="_blank" rel="nofollow">Connect</NuxtLink>
            </div>
        </div>
    </section>
</template>
